...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <form action="/post-product.php">
        ...
        <input placeholder="Enter image url link" name = "imageURL"/>
        <input placeholder="Enter the price" name = "price"/>
        <input placeholder="Enter the calories" name = "nutritionInfo"/>

        <label>Recommended For kids?</label><input placeholder="" name = "recommendedForKid" type="radio"/>
